...
if myMQTTClient.connect(keepAliveIntervalSecond=KEEP_ALIVE_SEC):
    ...
    while True:
        ...
        if packet:
            ...
            if p_type == 'AIR':
                ...
                current_status["pose"]["x"] = packet["posX"]
                current_status["pose"]["y"] = packet["posY"]
                current_status["pose"]["theta"] = packet["posTheta"]
